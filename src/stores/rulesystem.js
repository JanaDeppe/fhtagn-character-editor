...
export const useRulesystemStore = defineStore('rulesystem', {
  ...
  getters: {
    professionalSkillsById: state => id => state.professions[id].skills.fixed,
    optionalSkillsById: state => id => state.profession[id].skills.optional,
    availableOptionalSkillCount: state => id => state.professions[id].skills.optionalAmount,
    availableConnectionsCountById: state => id => state.professions[id].connections,
    professionsNameById: state => id => state.professions[id].name,
    facetteByName: state => key => (key ? state.facettes[key] : undefined),
    hasSpecialisationBySkillname: state => skillname => !!(state.skills[skillname].specialisation),
    ...
    baseSkillValueByName: state => skillname => state.skills[skillname].value,
  },
});